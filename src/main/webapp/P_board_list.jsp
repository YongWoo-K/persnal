   ...
   <div class="row">
      ...
      <div class="d-flex justify-content-center mt-3 align-items-center">
      	...
      	if(startBlock == 1){
      		...
      		out.println("<li class='off page-item'><a class='page-link' href='P_board_list.jsp?cpage=" + (startBlock-blockPerPage) + "'>&lt;</a></li>");
      	}
      	//바로 이전페이지로 이동
      	if(cpage == 1){
      		out.println("<li class='off page-item'><a class='page-link'>&lt;</a></li>");
      		...
      		out.println("<li class='off page-item'><a class='page-link' href='P_board_list.jsp?cpage=" + (cpage - 1) + "'>&lt;</a></li>");
      	}
      	...
      	for(int i = startBlock; i <= endBlock; i++){
      		if(cpage == i){
      			...
      			out.println("<li class='off page-item'><a class='page-link' href='P_board_list.jsp?cpage="+ i +"'>["+ i +"]</a></li>");
      		}
      	}
